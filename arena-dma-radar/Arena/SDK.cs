namespace SDK
{
    public readonly partial struct ClassNames
    {
        ...
        {
            public const uint ClassName_ClassToken = 0x2002235; // MDToken
        ...
        {
            public const uint ClassName_ClassToken = 0x2001928; // MDToken
            public const string ClassName = @"\uE86F";
        }

        public readonly partial struct GameSettings
        {
            public const uint ClassName_ClassToken = 0x20021EE; // MDToken
            public const string ClassName = @"\uEB20";
        }

        public readonly partial struct AmmoTemplate
        {
            public const uint ClassName_ClassToken = 0x2003271; // MDToken
            public const uint MethodName_MethodToken = 0x601333F; // MDToken
            public const string ClassName = @"\uF0CE";
        ...
        {
            public const uint ClassName_ClassToken = 0x2003C17; // MDToken
            public const string ClassName = @"\uF32F";
        }
        ...
        {
            public const uint MethodName_MethodToken = 0x6016E7D; // MDToken
        ...
        {
            public const uint ClassName_ClassToken = 0x2001D54; // MDToken
            public const uint MethodName_MethodToken = 0x600BA57; // MDToken
        ...
        {
            public const uint ClassName_ClassToken = 0x2000C9D; // MDToken
            public const uint MethodName_MethodToken = 0x600549F; // MDToken
        ...
        {
            public const uint ClassName_ClassToken = 0x2003575; // MDToken
            public const uint MethodName_MethodToken = 0x601419D; // MDToken
            public const string ClassName = @"\uF295";
        ...
        {
            public const uint ClassName_ClassToken = 0x2003216; // MDToken
            public const uint MethodName_MethodToken = 0x60130F5; // MDToken
        ...
        {
            public const uint ClassName_ClassToken = 0x200328D; // MDToken
            public const uint MethodName_MethodToken = 0x60133D9; // MDToken
    ...
    public readonly partial struct Offsets
    {
        ...
        {
            public const uint _characterController = 0x48; // -.ICharacterController
            ...
            public const uint EnabledAnimators = 0xA00; // System.Int32
        }
        ...
        public readonly partial struct PlayerInfo
        {
            ...
            public const uint Side = 0xA0; // System.Int32
        ...
        {
            public const uint WeaponLn = 0x194; // Single
